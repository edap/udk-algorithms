// read the sections additional rules of this page
// http://www.thealmightyguru.com/Wiki/index.php?title=Langton%27s_ant
// "By adding a third color, gray, the rule set must also be three letters long. Thus, "RLR" would mean turn right on the first color (white), left on the second color (gray), and right on the third color (black). "
// here a RLR implementation using red as third color
